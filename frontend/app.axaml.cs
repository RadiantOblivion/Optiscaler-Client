...
namespace OptiscalerClient
{
    public partial class App : Application
    {
        ...
        public static void ChangeLanguage(string langCode)
        {
            try
            {
                var uri = new Uri($"avares://OptiscalerClient/frontend/languages/strings.{langCode}.axaml");
                var include = new ResourceInclude(new Uri("avares://OptiscalerClient/frontend/app.axaml"))
                {
                    Source = uri
                };
